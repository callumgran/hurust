...
/*==========================================================================*
  ...
  DESCRIPTION
    This file contains the fixed-size stack data structure and macros for using it.
...
/**
 * \brief     A macro for checking if a stack is full.
 * \note      This macro checks if a stack is full.
